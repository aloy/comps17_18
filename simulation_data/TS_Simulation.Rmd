...
####
#Fix loop to add equal null and signal plots (Currently not enough null)
####
...
#save(TS_plot, file = "Linear_Trend_Plots.RData")
...
info_df <- ldply(TS_info, data.frame)
scatter_df <- ldply(TS_plot, data.frame)

scagnostics_df <- ldply(TS_scagnostics, data.frame)
