...
linear_wide_scagnostics <- read_csv("~/Desktop/Carleton College/Carleton '17-'18/Math Comps/Comps17_18/simulation_data/linear_wide_scagnostics.csv")
...
cat("Average Accuracy", mean(knn_cv_accuracy$accuracy))
