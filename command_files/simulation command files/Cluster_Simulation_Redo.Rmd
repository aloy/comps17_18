...
cluster_info_df <- ldply(c(info, nullInfo), data.frame)
cluster_scatter_df <- ldply(c(clusterPlots, nullPlots), data.frame)

write.csv(cluster_info_df, "Cluster_Info_Redo.csv")
write.csv(cluster_scatter_df, "Cluster_Plots_Redo.csv")
```
