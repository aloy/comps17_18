...
all_files <- data.frame(index = numeric(1), .n = numeric(1), n = numeric(1), df = numeric(1), naive1.qq.x = numeric(1), naive1.qq.y = numeric(1), seed = numeric(1), correct = numeric(1), signal = numeric(1))
