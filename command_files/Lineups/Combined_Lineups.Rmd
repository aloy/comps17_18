...
accuracy
#EU - .770, MA - .952, QDA - .965, LOG - .972, LEU - .770, LMA - .952
```
...
R = 5000
choices1 <- data.frame(correct.choice = numeric(R), eu.choice = numeric(R), maha.choice = numeric(R), loo.euclid = numeric(R), loo.maha = numeric(R))
