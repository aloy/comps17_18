...
par(mfrow = c(2,2))
plot(test$x, test$y, main = "Skewed: .382", xlab = "X", ylab = "Y", xaxt = "n", yaxt = "n")
plot(xy$x,xy$y, main = "Skewed: .651", xlab = "X", ylab = "Y", xaxt = "n", yaxt = "n")
plot(test2$x, test2$y, main = "Skewed: .877", xlab = "X", ylab = "Y", xaxt = "n", yaxt = "n")
```
