...
convex.low <- ggplot(ex1, aes(x = V1, y = V2)) +
  geom_point() +
  geom_polygon(data = ex1[path_nodes, ], aes(color = "raspberry"),  alpha = 0.5, fill = NA, size = 1.4) +
  ...
  labs(x = "", y = "")
convex.low
ggsave("for_presentation/convexPlotLow_Hulls.png", width = 6, height = 6, dpi = 500)
...
convex.med <- ggplot(df.main2, aes(x = V1, y = V2)) +
  geom_point() +
  geom_polygon(data = ex2[path_nodes, ], aes(color = "raspberry"),  alpha = 0.5, fill = NA, size = 1.4) +
...
convex.high <- ggplot(ex3, aes(x = V1, y = V2)) +
  geom_point() +
  geom_polygon(data = ex[path_nodes, ], aes(color = "raspberry"),  alpha = 0.5, fill = NA, size = 1.4) +
...
skinny.high <- ggplot(df1, aes(x = x, y = y)) +
  geom_point() +
  geom_polygon(data = ex1[path_nodes, ], aes(color = "#257985"),  alpha = 0.5, fill = NA, size = 1.4) +
  theme(legend.position = "none", axis.text = element_blank(), axis.ticks = element_blank()) +
  labs(x = "", y = "")
skinny.high
ggsave("for_presentation/skinnyPlotHigh_Hulls.png", width = 6, height = 6, dpi = 500)
...
>>>>>>> aac5e0205fd9720a4b09e5913d696950b00b8091
