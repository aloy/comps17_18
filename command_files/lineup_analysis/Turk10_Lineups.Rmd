...
accuracy <- data.frame(Euclidean = mean(choices$eu.choice == 20), 
                       Mahalanobis = mean(choices$maha.choice == 20),
                       LDA = mean(choices$lda.choice == 20),
                       Logistic = mean(choices$logit.choice == 20),
                       KNN = mean(choices$knn.choice == 20),
                       Random.Forest = mean(choices$rf.choice == 20))
accuracy
#EU - .083, MAH - .000, LDA - .063, LOG - .021, KNN - .063, RF - .063
#EU - .167, MAH - .146, LDA - .250, LOG - .333, KNN - .208, RF - .313 
