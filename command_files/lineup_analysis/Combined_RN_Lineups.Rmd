...
for(i in 1:K){
  ...
  lineup_null <- sample_n(null, R-n)
  lineup_scags <- rbind(lineup_signal, lineup_null) 
  lineup_scags$position <- sample(1:R, R)
...
#EU - .824, LDA - .949, QDA - .986, LOG - .972, KNN - .915, RF - .975
```
...
#AVERAGE RATE OF FALSE POSITIVES
  #EU = .173, LDA - .015, QDA - .042, LOG - .031, KNN - .023, RF - .031
...
#EU = .827, LDA - .865, QDA - .975, LOG - .962, KNN - .963, RF - .979
```
Accuracies of predictions do not change when the size of the lineups varies