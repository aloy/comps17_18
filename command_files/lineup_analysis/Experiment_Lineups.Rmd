...
for(set in 1:K){
  correct <- choices$correct.choice[[set]]
  fp2$Euclidean[set] <- 1 - mean(choices$eu.choice[[set]] %in% correct)
  fp2$Mahalanobis[set] <- 1 - mean(choices$maha.choice[[set]] %in% correct)
  fp2$LDA[set] <- 1 - mean(choices$lda.choice[[set]] %in% correct)
  fp2$QDA[set] <- 1 - mean(choices$qda.choice[[set]] %in% correct)
  fp2$Logistic[set] <- 1 - mean(choices$logit.choice[[set]] %in% correct)
  fp2$KNN[set] <- 1 - mean(choices$knn.choice[[set]] %in% correct)
  fp2$Random.Forest[set] <- 1 - mean(choices$rf.choice[[set]] %in% correct)
}  
