...
QQlineup.rf2 <- randomForest(as.factor(signal) ~ AD_pvalue + SW_pvalue + CVM_pvalue + lillie_pvalue + pearson_pvalue + SF_pvalue, data = train_data, ntree=100, importance =T)
